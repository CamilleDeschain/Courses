...
namespace CursoEntityCore01.Migrations
{
    ...
    [Migration("20221129183745_ActualizacionMigraDB")]
    partial class ActualizacionMigraDB
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CursoEntityCore01.Models.Articulo", b =>
                {
            ...
            modelBuilder.Entity("CursoEntityCore01.Models.ArticuloEtiqueta", b =>
                {
            ...
            modelBuilder.Entity("CursoEntityCore01.Models.Categoria", b =>
                {
                    b.Property<int>("Categoria_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            CategoriaId = 34,
                            Activo = false,
                            FechaCreacion = new DateTime(2021, 11, 29, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Nombre = "Categoría 6"
                        });
                });

            modelBuilder.Entity("CursoEntityCore01.Models.DetalleUsuario", b =>
                {
            ...
            modelBuilder.Entity("CursoEntityCore01.Models.Etiqueta", b =>
                {
                    b.Property<int>("Etiqueta_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CursoEntityCore01.Models.Usuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CursoEntityCore01.Models.Articulo", b =>
                {
                    b.HasOne("CursoEntityCore01.Models.Categoria", "Categoria")
                        .WithMany("Articulo")
            ...
            modelBuilder.Entity("CursoEntityCore01.Models.ArticuloEtiqueta", b =>
                {
                    b.HasOne("CursoEntityCore01.Models.Articulo", "Articulo")
                        .WithMany("ArticuloEtiqueta")
                        .HasForeignKey("Articulo_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CursoEntityCore01.Models.Etiqueta", "Etiqueta")
                        .WithMany("ArticuloEtiqueta")
            ...
            modelBuilder.Entity("CursoEntityCore01.Models.Usuario", b =>
                {
                    b.HasOne("CursoEntityCore01.Models.DetalleUsuario", "DetalleUsuario")
                        .WithOne("Usuario")
                        .HasForeignKey("CursoEntityCore01.Models.Usuario", "DetalleUsuario_Id");
