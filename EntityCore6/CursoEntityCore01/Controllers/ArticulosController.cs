using CursoEntityCore01.ViewModels;
using CursoEntityCore01.Datos;
...
namespace CursoEntityCore.Controllers
{
    public class ArticulosController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            //{
            //    //Opción 2: carga manual se generan muchas consultas SQL, no es eficiente si necesitamos cargar
            //    //más propiedades
        ...
        public IActionResult AdministrarEtiquetas(int id)
        {
            ...
            {
                ListaArticuloEtiquetas = _contexto.ArticuloEtiqueta.Include(e => e.Etiqueta).Include(a => a.Articulo).Where(a => a.Articulo_Id == id), ArticuloEtiqueta = new ArticuloEtiqueta(){ Articulo_Id = id},Articulo = _contexto.Articulo.FirstOrDefault(a => a.Articulo_Id == id)
            };
